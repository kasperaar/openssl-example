...
int main() {
  ...
  cout << "MD5 with 2 iteration!!" << endl;
  cout << Crypto::hex(Crypto::md5("Test", 2)) << endl << endl;
  ...
  cout << "SHA-256 with 2 iteration" << endl;
  ...
  cout << "SHA-512 with 2 iteration" << endl;
  cout << Crypto::hex(Crypto::sha512(Crypto::sha1("Test"))) << endl;
